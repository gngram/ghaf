...
def build_parser():
    ...
    p.add_argument("--dir", type=str, default="/run/usb-passthrough-manager/", help="Database directory for USB device manager, should be same as usb passthrough manager service")
